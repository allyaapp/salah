...
if(isset ($_POST['create']) ){
    ...
    $query = "INSERT INTO detailtransaksi VALUES ('' , '$id_user', '$id_barang', '$qty')";
...
<head>
    ...
    <title>Create Detail transaksi | SUGAR CANE</title>
    <!-- Favicon-->
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            <form action="dtransaksicreate.php" id="form_validation" method="POST">
