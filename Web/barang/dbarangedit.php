...
$sesLvl = $_SESSION['role'];
    ...
    if(isset($_POST['update']) ){
        ...
        $query = "UPDATE detailbarang SET id_detailukuran='$id_du', varianukuran='$varian', harga='$harga' WHERE id_detailukuran='$id_du'";
        $result = mysqli_query($koneksi, $query);
        header('Location: detailbarang.php');
    }

    $id = $_GET['id'];
    $query = "SELECT * FROM detailbarang WHERE id_detailukuran='$id'";
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            <form id="form_validation" method="POST" action="dbarangedit.php">
