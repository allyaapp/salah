                        ...
                        <div class="body">
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                    ...
                                    <?php 
                                        $query = "SELECT * FROM detailbarang";
                                    ...
                                    <tbody>
                                        <tr>
                                            <td><?php echo $no; ?></td>
                                            <td><?php echo $id; ?></td>
                                            <td><?php echo $varianukuran; ?></td>
                                            <td><?php echo $harga; ?></td>
                                            <td>
                                                <a href="dbarangedit.php?id=<?php echo $row['id_detailukuran']; ?>">
                                                    <input type="button" class="btn btn-info" value="Edit" name="edit" <?php echo $dis; ?>>
                                                </a>
                                                <a href="dbarangdelete.php?id=<?php echo $row['id_detailukuran']; ?>">
